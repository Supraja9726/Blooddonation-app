...
public class Detail  extends AppCompatActivity {
    EditText editName,editContact,editBloodgroup,editCity,editState;
    Button btnRegister;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(name.isEmpty() || contact.isEmpty() || bloodgroup.isEmpty() || city.isEmpty() || state.isEmpty() ) {
            Toast.makeText( Detail.this, "please enter all the details", Toast.LENGTH_SHORT ).show( );
        }else{
            String id=databaseReference.push().getKey();
            Donor donor=new Donor(name,contact,bloodgroup,city,state);
